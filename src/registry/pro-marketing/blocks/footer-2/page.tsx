...
export default function Component() {
  return (
    <footer className="bg-background mx-auto flex w-full max-w-[1440px] flex-col gap-12 pt-12 md:gap-9 lg:pt-20">
      <div className="flex flex-col gap-5 px-5 md:flex-row md:gap-9 lg:px-20">
      ...
      <div className="grid gap-12 px-5 sm:grid-cols-2 md:gap-9 lg:grid-cols-4 lg:px-20">
        {data.map((section) => (
      ...
      <div className="bg-muted px-5 py-9 lg:px-20">
